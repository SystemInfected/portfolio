...
const Portfolio = ({ data, images }: PortfolioProps) => {
	...
	return (
		<>
			<Head>
				<title>
					My Portfolio - Graphic Designer, Web Developer & Full-Stack Software
					Developer based in Stockholm, Sweden • Sebastian Widin's portfolio
				</title>

				<meta
					name='description'
					content="I am a Graphic Designer, Web Developer & Full-Stack Software Developer from Stockholm, Sweden. This is a selection of projects I'm proud of 😊"
				/>
				<meta
					name='image'
				...
				<meta
					name='og:title'
					content="My Portfolio - Graphic Designer, Web Developer & Full-Stack Software Developer based in Stockholm, Sweden • Sebastian Widin's portfolio"
				/>
				<meta
					name='og:description'
					content="I am a Graphic Designer, Web Developer & Full-Stack Software Developer from Stockholm, Sweden. This is a selection of projects I'm proud of 😊"
